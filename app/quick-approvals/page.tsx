...
/**
 * Admin-only queue for QUICK-disconnect requests on BASE-kitty customers.
 *
 * NEW-kitty quick disconnects continue to route through the CRM admin
 * queue (handled by the CRM webhook) and don't appear here.
 */
