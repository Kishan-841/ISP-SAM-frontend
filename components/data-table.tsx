        ...
        <table className={`w-full ${minWidth ?? ''}`.trim()}>
          <thead className="bg-gray-50/60 border-b border-gray-100">
            <tr className="divide-x divide-gray-100">
              {columns.map((col) => {
                ...
                return (
                  <th
                    ...
                    className={`px-5 py-3 text-xs font-semibold uppercase tracking-wider text-gray-500 whitespace-nowrap ${alignClass(col.align)} ${col.sortable ? 'cursor-pointer hover:text-gray-700 select-none' : ''}`}
                  >
              ...
              {actions && (
                <th className="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-500 whitespace-nowrap">
                  Actions
                </th>
              )}
            </tr>
